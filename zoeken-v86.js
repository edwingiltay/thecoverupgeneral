...
//
//  Integratie: plaats onder aan de <body>  <script src="zoeken-v86.js" defer></script>
//  (mobiele pagina's in m/ gebruiken  ../zoeken-v86.js ).
...
(function () {
  ...
  var zelfScript = document.querySelector('script[src*="zoeken-v86.js"]');
  var basisPad = zelfScript ? (zelfScript.getAttribute('src') || '').replace(/zoeken-v86\.js.*$/, '') : '';
  var boekBestand = (LANG === 'nl') ? { pdf: 'boek.pdf', index: 'boek-index-v86.js' } : { pdf: 'book.pdf', index: 'book-index-v86.js' };
  ...
  var DOCIDX = { url: basisPad + 'doc-index-v86.js?r=32', map: basisPad + 'doc/' };
  ...
  var css = ''
    ...
    + '.zk-x{border:0;background:#f0f0f0;color:#900000;border-radius:5px;cursor:pointer;font-size:13px;padding:5px 9px;font-family:inherit}'   // donkerrode sluitknop
    + '.zk-x:hover{background:#e2e2e2}'
  ...
  overlay.innerHTML =
    ...
    +     '<button class="zk-x" type="button">' + esc(T.sluit) + '</button>'
    +   '</div>'
