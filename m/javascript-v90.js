/* Gedeelde scripts voor de mobiele pagina's (m/).
   ...
   Wordt geladen met defer, en bewust VOOR ../zoeken-v90.js: de zoekfunctie leest
...
(function(){
  ...
  /* Per land het vlagteken zoals het op de kaart staat, zodat de knop straks dezelfde
     tekens draagt als de bronregel en dus dezelfde glyph uit flags-v90.woff2 pakt. */
  var vlagVan = {};
  ...
  function toon(groep){
    ...
    /* Het scheidingsbolletje in een eigen span, zodat m/stylesheet-v90.css het een tikje
